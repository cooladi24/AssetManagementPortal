...
<%
		try{
			...
			String sql1 ="create table asset(assetid varchar(15) not null primary key, assetdesc varchar(30) not null,version varchar(15) not null, loc varchar(30) not null,type int(2) not null, assetclass int(2) not null, validity varchar(20) not null, backup varchar(5) not null, assetown varchar(12))";
